...
%\noindent
%(Ort, Datum)\hfill						(Alexander Lahn, Unterschrift)

%\noindent 
%(Ort, Datum)\hfill						(Henning Diederich, Unterschrift)
...
\begin{tabular}{m{7cm} m{7cm}}
    \vspace{1.3cm}Dieburg, 14.02.2025 & \vspace{0.2cm}\includegraphics[width=4cm,height=1.5cm]{unterschriftPH.jpg} \\
    \multicolumn{1}{c}{\hspace{-2cm}\rule{5cm}{0.4pt}} & \multicolumn{1}{c}{\hspace{-2cm}\rule{5cm}{0.4pt}} \\
