...
\begin{figure}[H]
	\caption{Filterung}
	\includegraphics[width=1.\textwidth]{data_prep_filter}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{data_prep_sprache_text}
...
\begin{figure}[H]
	...
	\includegraphics[width=.95\textwidth]{data_prep_dokucorp_ipcanalyse}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.85\textwidth]{data_prep_datakorpu_topicmodel}
...
\begin{figure}[H]
	...
	\includegraphics[width=.95\textwidth]{topics}
	\label{fig:topics}
	\vspace{0.5em}
	\raggedright
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{data_prep_dokukorp_analysis}
...
\begin{figure}[H]
	...
	\includegraphics[width=1.\textwidth]{ipc_verteilung}
...
\begin{figure}[H]
	...
	\includegraphics[width=1.\textwidth]{ipc_topic_distr}
...
\begin{figure}[H]
	...
	\includegraphics[width=1.\textwidth]{tech_topicdistr}
...
\begin{figure}[h]
	...
	\includegraphics[width=1.\textwidth]{eu_topics_tech}
...
\begin{figure}[h]
	...
	\includegraphics[width=1.\textwidth]{usa_topics_tech}
...
\begin{figure}[H]
	...
	\includegraphics[width=1.\textwidth]{ch_topics_tech}
...
\begin{figure}[H]
	...
	\includegraphics[width=1.\textwidth]{task_topicdistr}
...
\begin{figure}[!h]
	...
	\includegraphics[width=1.\textwidth]{eu_topics_task}
...
\begin{figure}[h]
	...
	\includegraphics[width=1.\textwidth]{usa_topics_task}
...
\begin{figure}[H]
	...
	\includegraphics[width=1.\textwidth]{ch_topics_task}
