...
\newcommand{\daMatrikelnummer}{701650, 513466, 732259}
\newcommand{\daTitel}{Ein besonderes Thema-das-interessant-ist}
\newcommand{\daTitelEins}{Automatisierte RCA in Microservices:}
\newcommand{\daTitelZwei}{Integration eines LLM in Nezha zur}
\newcommand{\daTitelDrei}{verbesserten Fehleridentifikation}
...
\newcommand{\daStudiengang}{Big Data \& Business Analytics}

\newcommand{\daAutorAdresse}{~ }
\newcommand{\daAutorPLZ}{~ }
\newcommand{\daAutorOrt}{~ }

\newcommand{\daDate}{14.02.2025}


\newcommand{\daGutachterEins}{Prof. Dr. Klemens Waldhör}
