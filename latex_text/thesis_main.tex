...
%	numbers=left,
%	captionpos=b,
%	%xleftmargin=0pt,  % Align to the left edge
...
% Customize the appearance of the list of equations


\usepackage{amsmath}  % Erweiterte mathematische Umgebungen
\usepackage{amsfonts} % Erweiterte mathematische Schriftarten
\usepackage{amssymb}  % Erweiterte mathematische Symbole
\usepackage{newfloat} % Paket zur Definition neuer Gleitobjekte
...
% für python code einbindung
\input{preamble/python_code}
...
% \printbibliography[heading=bibintoc,title={\langde{Quellenverzeichnis}\langen{Bibliography}}]

\printbibliography[nottype=misc, heading=bibintoc, nottype=online]
\newpage
\printbibliography[keyword=extra, title={Sonstige Quellen}]
\newpage
% ehrenwörtliche Erklärung
\pagenumbering{gobble} % dies entfernt die Seitenzahl auf den nachfolgenden Seiten, hier kommt dann die EE hin, ob dreimal müssen wir noch besprechen!
\input{kapitel/ee}
